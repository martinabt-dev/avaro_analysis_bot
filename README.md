Terms of Service für Avaro

Letzte Aktualisierung: 18. Juni 2026

Diese Nutzungsbedingungen gelten für den Discord-Bot Avaro („der Bot“), der in Discord-Servern verwendet wird.
...
Analyse und Auswertung von Logs (z. B. FFLogs)
Raid- und Gruppenmanagement-Funktionen
Statistische Auswertungen
Discord-Integration für FFXIV-bezogene Inhalte
...
Discord User IDs
Server IDs
Nachrichteninhalte, sofern sie für eine Anfrage erforderlich sind (z. B. Command-Nutzung)
öffentlich zugängliche FFXIV/FFLogs-Daten (falls verwendet)
...
Analyseergebnisse (z. B. Logs, Rankings)
...
permanente Verfügbarkeit des Bots
fehlerfreie Funktion
bestimmte Features oder Updates
...
Entscheidungen, die auf Basis der Bot-Ausgaben getroffen werden
...
den Bot absichtlich zu überlasten (Spam, Flooding)
Sicherheitsmechanismen zu umgehen
den Bot für unerlaubte oder illegale Zwecke zu verwenden
